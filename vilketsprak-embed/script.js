...
function createlistamedbilder(){
  listamedbilder = [];
  listamedbilder.push("<pre>IT'S SHOWTIME <br>TALK TO THE HAND \"hello world\" <br>YOU HAVE BEEN TERMINATED</pre>");
  ...
  listamedbilder.push("<pre>print(\"Hello World\")</pre>");
  listamedbilder.push("Scratch.png");
  listamedbilder.push("Whitespace.png");
  listamedbilder.push("<pre>main = putStrLn \"Hello, World!\"</pre>");
  listamedbilder.push("<pre>('&%:9]!~}|z2Vxwv-,POqponl$Hjig%eB@@&gt; <br>}=&lt;M:9wv6WsU2T|nm-,jcL(I&%$#\" <br>`CB]V?Tx&lt;uVtT`Rpo3NlF.Jh++FdbCBA@?]! <br>~|4XzyTT43Qsqq(Lnmkj\"Fhg${z@&gt;</pre>");
  listamedbilder.push("<pre>Write-Host \'Hello World!\'</pre>");
  listamedbilder.push("<pre>Debug.Log(\"Hello World\");</pre>");
...
function getNames() {
  return ["ArnoldC", "HTML", "Java", "LOLCODE", "Python", "Scratch", "Whitespace", "Haskell", "Malbolge", "Power shell", "Unity", "COBOL"]
}
